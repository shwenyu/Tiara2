...
Model-location precedence is `--bundle`, configuration `model_bundle`, `TIARA2_MODEL_BUNDLE`, then the bundled model. Explicit runtime CLI arguments override the JSON file.
